...
import NavBarDashboardQualityAndAssurance from "./nav-dashboard-quality-assurance";

export function AppSidebarQualityAndAssurance({
  ...props
  ...
  return (
    ...
    >
      ...
      <SidebarContent className="font-bold">
        <NavBarDashboardQualityAndAssurance />
      </SidebarContent>
