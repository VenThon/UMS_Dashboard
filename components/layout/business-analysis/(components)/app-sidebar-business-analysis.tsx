...
import NavBarDashboardBusinessAndAnalysis from "./nav-dashboard-business-analysis";

export function AppSidebarBusinessAndAnalysis({
  ...props
  ...
  return (
    ...
    >
      ...
      <SidebarContent className="font-bold">
        <NavBarDashboardBusinessAndAnalysis />
      </SidebarContent>
