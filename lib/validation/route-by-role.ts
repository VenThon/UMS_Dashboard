...
const businessAndAnalysisDashboard =
  "/dashboard/business-analysis/statistics";
const ctoDashboard =
  "/dashboard/cto/statistics";
...
const managementDashboard =
  "/dashboard/managements/statistics";
const qualityAndassuranceDashboard =
  "/dashboard/quality-assurance/statistics";
const suportDashboard =
  "/dashboard/support/statistics";
const developmentSettings =
  "/dashboard/developments/settings";
const businessAndAnalysisSettings =
  "/dashboard/business-analysis/settings";
const ctoSettings =
  "/dashboard/cto/settings";
const designSettings =
  "/dashboard/design/settings";
const infrastructureAndOperationSettings =
  "/dashboard/infrastructure-operation/settings";
const managementSettings =
  "/dashboard/managements/settings";
const qualityAndassuranceSettings =
  "/dashboard/quality-assurance/settings";
